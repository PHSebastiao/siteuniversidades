...
<body>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="cursosDelete.php" method="POST">
                    <div class="modal-body">
                        <input type="hidden" name="delete_id" id="delete_id">
                        Realmente deseja deletar o curso?
                    </div>
    ...
    <main>
        <div class="container my-5">
            <h1>Gerenciador Cursos</h1>
            <div class="d-flex justify-content-end">
                <a class="btn btn-success mb-3" href="./cursosCriar.php">Criar Curso</a>
            </div>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $linha['Codigo'] ?></td>
                            <td>
                                <a class="btn btn-sm btn-info" href="./cursosEdit.php?id=<?= $linha['IdCurso'] ?>"><i class="bi bi-pencil"></i></a>
